    ...
    return (
        ...
        >
            <div className="w-full mx-auto my-5 px-20 max-w-screen-2xl">
                <motion.div
                    className="flex flex-col items-center justify-center md:flex-row w-full h-[40rem] my-5 p-20 rounded-2xl md:rounded-[32px] max-w-screen-2xl bg-gradient-to-r from-primary to-cprimary text-dbase"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
